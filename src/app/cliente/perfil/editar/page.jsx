            ...
            <Box sx={{ width: '100%', mb: 4 }}>
              <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                ...
                >
                  ...
                  <Tab icon={<LocationOn />} label="Endereços" iconPosition="start" />
                  <Tab icon={<History />} label="Histórico" iconPosition="start" />
                  <Tab icon={<EmojiEvents />} label="Conquistas" iconPosition="start" />
                </Tabs>
              </Box>
                    ...
                    <Grid item xs={12} sm={6}>
                      <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Typography variant="body1" sx={{ mt: 1 }}>
                          {userData?.name || user?.displayName || 'Não informado'}
                        </Typography>
                      </Paper>
                    </Grid>
                        ...
                        >
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap' }}>
                            <Box>
                              ...
                              <Typography variant="body2" color="text.secondary">
                                Materiais: {schedule.wastes?.map(w => w.wasteId?.name || 'Resíduo').join(', ')}
                              </Typography>
                            </Box>
